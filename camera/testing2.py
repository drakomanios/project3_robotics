...
while True:
    ...
    marker = aruco_detector.detectMarkers(frame)
    # print(marker)
    print(camera_utils.estimate_ArUco_marker_pose(frame , ArUco_marker = marker[0],intrinsic_mat=camera_matrix,dist_coeffs=dist_coeffs))
